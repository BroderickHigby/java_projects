 ...
 * Program: PartiallyFilledArray.java
 * Date: 12 April 2015
 ...
 * the use of Partially filled arrays and calling them.  Class for a partially filled array of doubles. The class enforces the
 * following invariant: All elements are at the beginning of the array in locations 0, 1, 2, and so forth up to a highest index
 * with no gaps.
 */
