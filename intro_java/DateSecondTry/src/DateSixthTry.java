...
public class DateSixthTry //Start of class
{
    private String month;
    private int day;
    private int year; //a four digit number.
    //if else loops created to check date
    ...
    public void setDate(String monthString, int day, int year)
    {
        ...
        {
            System.out.println("Fatal Error");//used to keep compiler happy
            System.exit(0);
        }
    }
