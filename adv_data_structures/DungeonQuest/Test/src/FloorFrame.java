...
public class FloorFrame 
{
	...
	public FloorFrame()
	{
		...
		floorPanel.add(new JLabel(new ImageIcon("Wall.png")));
		floorPanel.add(new JLabel(new ImageIcon("Wall.png")));
		floorPanel.add(new JLabel(new ImageIcon("FloorChestplateGreen.gif")));
		floorPanel.add(new JLabel(new ImageIcon("Floor.png")));
		floorPanel.add(new JLabel(new ImageIcon("Floor.png")));
		floorPanel.add(new JLabel(new ImageIcon("Floor.png")));
		floorPanel.add(new JLabel(new ImageIcon("Wall.png")));
	...
	{
		tiles[0] = new JLabel();
		ImageIcon i = new ImageIcon("FloorScaledby9.png");
		tiles[0].setIcon(i);
	}
	...
	{
		tiles[1] = new JLabel();
		ImageIcon i = new ImageIcon("Wall.png");
		tiles[1].setIcon(i);
	}
	
	private void buildCharacterTile()
	{
		tiles[2] = new JLabel();
		ImageIcon i = new ImageIcon("Character.png");
		tiles[2].setIcon(i);
	}*/
}