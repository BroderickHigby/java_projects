 ...
 * Program Description: Write a program that reads both the girl and boy files into memory using arrays.
 ...
 * 3. Take user input with a scanner 
 */
...
/**********This pulls the .txt files in a try-catch block*****/
		try {	
		boyInput = new Scanner(new FileInputStream(""
				+ "/Users/brody/Documents/Workspace/Popular Names File IO Week 5/src/boynames.txt"));
		girlInput = new Scanner(new FileInputStream(""
				+ "/Users/brody/Documents/Workspace/Popular Names File IO Week 5/src/girlnames.txt"));	
...
/*****************This scans in the users input********************************/
		...
		System.out.println("Welcome to the Amazing Names Program"); 
...
/*******This takes the rank in the list of the name that the user inputted*****/
		...
		if(found)
		{
		 	System.out.printf("The name %s is ranked %d in popularity among the top "
						+ "1000 boys names with %d namings\n",boyNamesObj, boyPopularityObj, boyRanked);
		}
		else
		{
			System.out.printf("%s is not ranked among the top 1000 boys names\n", boyNamesObj);
		}
			found = false;
		...
		{
			System.out.printf("The name %s is ranked %d in popularity among the top " 
					+ "1000 girls names with %d namings",girlNamesObj, girlPopularityObj, girlRanked);
		}
		else
		{
			System.out.printf("%s is not ranked among the top 1000 girls names\n", girlNamesObj);
		}
