/*
 * Demonstrates where the clone method works, but the copy constructors do not
 */
public class CopyingDemo 
{
	public static void main(String[] args)
	{
		...
		a[1] = new DiscountSale("invisable paint", 5.00, 10);
		int i;
	...
	/**
	 * Supposedly returns a dafe copy of a. That is, if b is the 
	 ...
	 */
	public static Sale[] goodCopy(Salep[] a)
	{
		Sale[] b = new Sale[a.length];
		for (int i = 0; i< a.length; i++)
			b[i] = a[i].clone();
